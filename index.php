...
$navBar = '<div class="hamberger-menu">
...
<a class="profile-link" href="profile.html"><svg style="color: rgb(25, 46, 94);"
        xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
        class="bi bi-person-circle" viewBox="0 0 16 16">
        <path d="M11 6a3 3 0 1 1-6 0 3 3 0 0 1 6 0z" fill="#192e5e"></path>
